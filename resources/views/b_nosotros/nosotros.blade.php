...
@section('content')
    ...
    <div class="social-sidebar">
        ...
        <div class="social-buttons-vertical">
            <a href="#" class="social-btn-minimal"><i class="fab fa-facebook-f"></i></a>
            <a href="#" class="social-btn-minimal"><i class="fab fa-twitter"></i></a>
            <a href="#" class="social-btn-minimal"><i class="fab fa-instagram"></i></a>
            <a href="#" class="social-btn-minimal"><i class="fab fa-linkedin-in"></i></a>
        </div>
