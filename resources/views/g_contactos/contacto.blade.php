    ...
    <section class="banking-section">
        <div class="banking-container">
            <div class="banking-header">
                ...
                <p>Para pagos y transferencias directas</p>
            </div>
            ...
            <div class="banking-grid">
                <div class="bank-card">
                    ...
                    <div class="bank-details">
                        <div class="detail-item">
                            ...
                            <span class="detail-value">Banco de Crédito del Perú</span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Cuenta:</span>
                            <span class="detail-value">194-1234567-8-90</span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">CCI:</span>
                            <span class="detail-value">002-194-001234567890-12</span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Titular:</span>
                            <span class="detail-value">Aerolíneas del Sur S.A.C.</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bank-card">
                    ...
                    <div class="bank-details">
                        ...
                        <div class="detail-item">
                            <span class="detail-label">Cuenta:</span>
                            <span class="detail-value">194-9876543-2-10</span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">CCI:</span>
                            <span class="detail-value">002-194-009876543210-34</span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Titular:</span>
                            <span class="detail-value">Aerolíneas del Sur S.A.C.</span>
            ...
            <div class="schedule-grid">
                ...
                <div class="schedule-card">
                    ...
                    <div class="schedule-times">
                        <div class="time-item">
                            <span class="day">Lunes - Domingo</span>
                            <span class="time">6:00 - 23:00</span>
                        </div>
                    </div>
