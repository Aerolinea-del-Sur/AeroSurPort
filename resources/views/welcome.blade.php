        ...
        <form class="main-form">
            ...
            <header class="site-header navbar navbar-expand-lg fixed-top" >
                <div class="container-fluid">
                  <!-- Logo -->
                  <a class="navbar-brand me-auto" href="https://russellexperienceperutravel.com/">
                    <img src="{{ asset('img/logo/logo.png') }}" alt="Russell Experience" class="site-logo" style="height: 50px;">
                  </a>
                  ...
                  <nav class="collapse navbar-collapse" id="mainNav">
                    <ul class="navbar-nav ms-auto">
                      ...
                      <li class="nav-item">
                        <a class="nav-link text-white" href="/service">SERVICIOS</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link text-white" href="/contact">CONTACTOS</a>
                      </li>
                    </ul>
                  </nav>
                </div>
